...
import { View, TextInput, TouchableWithoutFeedback, Keyboard,  I18nManager, EmitterSubscription, StyleSheet, Platform, } from 'react-native'
...
export default class OTPInputView extends Component<InputProps, OTPInputViewState> {
    ...
    renderOneInputField = (_: TextInput, index: number) => {
        const { codeInputFieldStyle, codeInputHighlightStyle, codeInputFilledStyle ,secureTextEntry, editable, keyboardType, selectionColor, keyboardAppearance } = this.props
        ...
        return (
            <View pointerEvents="none" key={index + "view"} testID="inputSlotView">
                <TextInput
                    ...
                    style={selectedIndex === index ? [defaultTextFieldStyle, codeInputFieldStyle, codeInputHighlightStyle]: index < selectedIndex ? [defaultTextFieldStyle, codeInputFieldStyle, codeInputFilledStyle]: [defaultTextFieldStyle, codeInputFieldStyle]}
